...
<!-- Pour la mise a jrs des donnees-->
<?php
// 1 : on ouvre le fichier
$monfichier = fopen('Storage/Formations.json', 'r+');
...
// 2 : on fera ici nos opérations sur le fichier...
	...
	// fseek($monfichier, 0); 
	// on ecrit 
	//fputs($monfichier, 'Texte de test');
...
$contenu_fichier_json = file_get_contents('Storage/Formations.json');
	    ...
	    <div class="wrap">  		 
	       <div class="column_left">	
            ...
            <div class="column_middle">
				...
				<h1 style="margin-left:20px;margin-right:20px;"> Les Formations</h1>
		            ...
		            <table style="margin-left:20px;margin-right:20px;">
						...
						<tr>
						<td><?php echo $tr['titre']?></td>
						<td><?php echo $tr['date_debut']?></td>
						<td><?php echo $tr['Periode']?></td>
						<td><?php echo $tr['Formateur']?></td>
						
						<td><input type="submit" class="myButton" value="S'Enregistrer"></td>
						</tr>
						<tr>
						<td>AGIRH</td>
						<td>01/06/2016</td>
